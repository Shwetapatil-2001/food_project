...
<body class="body1">
  ...
  <div class="container">
    ...
    <input type="text" class="search" name="search" placeholder="Search for food.... (e.g. breakfast_food, chinese_food, etc)"  style="width: 500px; height: 40px; border: radius 2%;margin-left:250px; margin-bottom: 25px;border:solid 2px;">
    <button type="submit" class="searchb" style="height: 40px; width: 70px; border: radius 2%; border:solid 2px;">Search</button>
    </form>
  </div>
